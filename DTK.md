...
- `request`
- `notes`
- `format` (optional parser override such as `json`, `yaml`, `toml`, `csv`, `ini`, `xml`, or `xaml`)
- `content_path`
- `allow`
