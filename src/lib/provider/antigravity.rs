...
const ANTIGRAVITY_RULES: &str = r#"# DTK - Structured Payload Routing (Google Antigravity)
...
pub(crate) fn install_antigravity_guidance() -> io::Result<bool> {
    install_text_file(rules_path(), ANTIGRAVITY_RULES)
}

pub(crate) fn uninstall_antigravity_guidance() -> io::Result<bool> {
