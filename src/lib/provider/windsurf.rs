...
const WINDSURF_RULES: &str = r#"# DTK - Structured Payload Routing (Windsurf)
...
pub(crate) fn install_windsurf_guidance() -> io::Result<bool> {
    install_text_file(rules_path(), WINDSURF_RULES)
}

pub(crate) fn uninstall_windsurf_guidance() -> io::Result<bool> {
