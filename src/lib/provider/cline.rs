...
const CLINE_RULES: &str = r#"# DTK - Structured Payload Routing (Cline)
...
pub(crate) fn install_cline_guidance() -> io::Result<bool> {
    install_text_file(rules_path(), CLINE_RULES)
}

pub(crate) fn uninstall_cline_guidance() -> io::Result<bool> {
